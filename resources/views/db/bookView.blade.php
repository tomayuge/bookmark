...
<table>
    <tr><td rowspan="6"><img src="{{ $record -> img }}" height="300"></td></tr>
    <tr><td>{{ $records -> book_name }}</td></tr>
    <tr><td><star-rating v-bind:increment="0.1"
                         star-points="{{ $record -> reviews -> average('score') }}">
    ...
    @foreach($records as $record)
        <tr>
            ...
            <td><star-rating v-bind:increment="0.1"
                         star-points="{{ $records -> review -> score }}">
                         <!-- star-pointsで動かなければinlineに書き換えてみる -->
            </star-rating>  </td>
                 ...
                 <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="id" value="{{ $record -> review -> id }}">
                            <input type="textarea" name="comment" value="{{ $record -> review -> comment }}">
